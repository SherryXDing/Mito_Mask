...
# checkpoint
model_path = '/groups/flyem/data/dingx/mask/model_depth4_insz108/'  # '/groups/flyem/data/dingx/mask/model_depth3_insz64/'
ckpt_list = ['model_ckpt_1000.pt', 'model_ckpt_2000.pt', 'model_ckpt_3000.pt', 'model_ckpt_4000.pt', 'model_ckpt_5000.pt']
...
for ckpt in ckpt_list:
    ...
    save_name = 'multidata_result_{}.h5'.format(os.path.splitext(ckpt)[0])
